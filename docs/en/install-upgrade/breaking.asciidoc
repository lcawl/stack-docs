...
The following sections summarize the most important breaking changes in Beats
{version}. For the complete list, go to
...
The following sections summarize the most important breaking changes in {es}
{version}. For the complete list, go to
...
The following sections summarize the most important breaking changes in {kib}
{version}.  For the complete list, go to
