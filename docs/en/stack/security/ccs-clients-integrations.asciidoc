...
include::{es-repo-dir}/security/ccs-clients-integrations/cross-cluster.asciidoc[]
...
include::{es-repo-dir}/security/ccs-clients-integrations/java.asciidoc[]
...
include::{es-repo-dir}/security/ccs-clients-integrations/http.asciidoc[]
...
include::{es-repo-dir}/security/ccs-clients-integrations/hadoop.asciidoc[]

:edit_url: https://github.com/elastic/stack-docs/edit/{branch}/docs/en/stack/security/ccs-clients-integrations/beats.asciidoc
include::ccs-clients-integrations/beats.asciidoc[]

:edit_url: https://github.com/elastic/stack-docs/edit/{branch}/docs/en/stack/security/ccs-clients-integrations/monitoring.asciidoc
