...
[role="screenshot"]
image::ml/images/ml-create-job.jpg["Job creation wizards in {kib}"]
...
--
[role="screenshot"]
image::ml/images/ml-data-visualizer.jpg["Data Visualizer in {kib}"]
--
...
[role="screenshot"]
image::ml/images/ml-data-metrics.jpg["Data Visualizer output for metrics in {kib}"]
...
[role="screenshot"]
image::ml/images/ml-data-topmetrics.jpg["Data Visualizer output for top values in {kib}"]
...
[role="screenshot"]
image::ml/images/ml-data-dates.jpg["Data Visualizer output for date fields in {kib}"]
...
[role="screenshot"]
image::ml/images/ml-data-keywords.jpg["Data Visualizer output for date fields in {kib}"]
