...
include::{es-repo-dir}/ml/anomaly-detection/apis/ml-api.asciidoc[lines=1..7,leveloffset=+2]

include::{es-repo-dir}/ml/anomaly-detection/apis/post-calendar-event.asciidoc[leveloffset=+2]
